...
2.10.3之前版本青龙拉库命令:
	...
	ql repo https://github.com/xyzol/QLScript2.git "jd_" "NoUsed" "ql|utils"

	包含sendNotify:

	ql repo https://github.com/xyzol/QLScript2.git "jd_" "NoUsed" "ql|sendNotify|utils"
...
2.10.3之后版本青龙拉库命令:
	...
	ql repo https://github.com/xyzol/QLScript2.git "jd_" "NoUsed" "ql|utils|USER_AGENTS|jdCookie|JS_USER_AGENTS"

	包含sendNotify:

	ql repo https://github.com/xyzol/QLScript2.git "jd_" "NoUsed" "ql|sendNotify|utils|USER_AGENTS|jdCookie|JS_USER_AGENTS"
